    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-6">
                <img src="<?php echo base_url() ?>/uploads/about-img.svg" class="img-fluid about-img" alt="img"/>
            </div>
            ...
            <div class="col-md-12 col-lg-6 col-sm-12 mob-hide2">
                <div class="tab-content">
                    <div id="homeq" class="container tab-pane active"><br>
                        <p class="features-text">দ্রুত এবং নিখুঁত হিসাবের জন্য আমাদের সফটওয়্যারটি বেস্ট। এই
                    ...
                    <div id="menu1q" class="container tab-pane fade"><br>
                        <p class="features-text">আপডেট টেকনোলজি এবং প্রোগ্রামিংয়ের মাধ্যমে সহজ হিসাব সফটওয়্যারটি তৈরি করা আপনি কোন প্রকার সমস্যা ছাড়াই হিসাব করতে পারবেন আপডেট টেকনোলজি এবং প্রোগ্রামিংয়ের মাধ্যমে সহজ হিসাব সফটওয়্যারটি তৈরি করা আপনি কোন প্রকার সমস্যা ছাড়াই হিসাব করতে পারবেন</p>
                    </div>
                    <div id="menu2q" class="container tab-pane fade"><br>
                        <p class="features-text">সময় অনেক মূল্যবান বিশেষ করে যারা ব্যবসায়ী তাদের সময়ের মূল্য অনেক বেশি। এই সফটওয়্যারটি ব্যবহারের মাধ্যমে আপনি বছরে অনেক সময় বাঁচাতে পারবেন । যার ফলে শারীরিক ও মানসিক চাপমুক্ত থাকবেন। </p>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 col-sm-12" style="margin-top: 145px;">
                <ul class="ul-soft">
                    ...
                    <li class="li-text">আপনি অনলাইনের মাধ্যমে যেকোনো প্রান্ত থেকে সফটওয়্যারটির হিসাব নিকাশ দেখতে পারবেন।
                    </li>
                    <li class="li-text">আপনার ব্যবসার অনাকাঙ্ক্ষিত ক্ষতির পরিমাণ অনেক কমে যাবে।</li>
                    <li class="li-text">হিসাবের স্বচ্ছতা থাকার কারণে আপনি সবসময় চিন্তামুক্ত থাকতে পারবেন। ফলে আপনি ব্যবসার জন্য ভালো ভালো ডিসিশন নিতে পারবেন।</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row" style="margin-top: 60px;">
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/book2151.svg" alt="">
                    </div>
                    <div class="col-10">
                        <p class="text-ti">ডেইলি বুক</p>
                    </div>
            ...
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/ledg2098.svg" alt="">
                    </div>
                    <div class="col-10">
            ...
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/stock2099.svg" alt="">
                    </div>
                    <div class="col-10">
            ...
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/appli2100.svg" alt="">
                    </div>
                    <div class="col-10">
            ...
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/bank2101.svg" alt="">
                    </div>
                    <div class="col-10">
                        <p class="text-ti">ব্যাংক একাউন্ট ম্যানেজমেন্ট</p>
                    </div>
                    <div class="col-12 mar-t-10">
                        <p class="text-text">এর মাধ্যমে আপনি আপনার প্রতিষ্ঠানের কতগুলি ব্যাংক অ্যাকাউন্ট রয়েছে সেগুলো ম্যানেজ করতে পারবেন এবং প্রতিটা ব্যাংকে কি পরিমান অর্থ ডিপোজিট করলেন অথবা কি পরিমাণ অর্থ উইথড্র করলেন, কারোর কাছে কোন চেক পাবেন কিনা বা চেক দিলেন কিনা সমস্ত তথ্য আপনি এই ব্যাংক ম্যানেজমেন্ট এর মাধ্যমে পাবেন। </p>
                    </div>
                </div>
            </div><!-- end col -->
            <div class="col-md-4">
                <div class="row features2-box">
                    <div class="col-2">
                        <img src="<?php echo base_url() ?>/uploads/trans2102.svg" alt="">
                    </div>
                    <div class="col-10">
...
<div id="install" class="section" style="padding-top: 0px !important;">
    <div class="container">
        <div class="row text-center">
            <div class="col-12">
                <p class="install-ti">কিভাবে আপনার <span class="color-text">কম্পিউটারে ইনস্টল দিবেন</span></p>
            </div>
        </div>
        <div class="row">
            <div class="col-12 " style="margin-top: 100px;">
                ...
                <div class="box-row text-center">
                    <img src="<?php echo base_url() ?>/uploads/Vector 55.svg" alt="" class="vec">
                </div>
                ...
                <div class="box-row text-center">
                    <img src="<?php echo base_url() ?>/uploads/Vector 56.svg" alt="" class="vec-56 vec">
                </div>
                ...
                <div class="box-row text-center">
                    <img src="<?php echo base_url() ?>/uploads/Vector 57.svg" alt="" class="vec">
                </div>
            ...
            <div class="col-md-12 col-lg-6 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-12" style="margin-top: 20px;">
                        ...
                        <button class="btn btn-used"> ট্রান্সপোর্ট এজেন্সি</button>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 d-flex flex-wrap justify-content-between" style="margin-top: 80px; padding: 0px 70px;">
                <img src="<?php echo base_url() ?>/uploads/Group.svg" alt="" class="img-us-1">
                ...
                <img src="<?php echo base_url() ?>/uploads/Group.svg" alt="" class="img-us-2">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 d-flex flex-wrap justify-content-between" style="margin-top: 80px;">
                <img src="<?php echo base_url() ?>/uploads/logo2 1.svg" alt="" class="pat-img">
                <img src="<?php echo base_url() ?>/uploads/logo (2) 1.svg" alt="" class="pat-img">
                <img src="<?php echo base_url() ?>/uploads/logo (1) 1.svg" alt="" class="pat-img">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree4" class="collapse" aria-labelledby="headingThree4"
                             data-parent="#accordionExample">
                            <div class="card-body">
                                সাধারণ ব্যবসায়িক সফটওয়্যার এর যে বিষয়গুলো দরকার হয়। আমরা সে সমস্ত বিষয়ের উপরে মডিউল তৈরি করে রেখেছি এছাড়াও যদি আপনার যদি ভিন্ন কিছু মডিউল প্রয়োজন পড়ে, সে ক্ষেত্রে আমাদেরকে বললে আলোচনা সাপেক্ষে আপনার সফটওয়্যারটি তৈরি করে দিব।
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                            ...
                            <h5 class="mb-0">
                                <a href="" class="btn-link collapsed" type="button" data-toggle="collapse"
                                   data-target="#collapseThree5" aria-expanded="false" aria-controls="collapseThree5">
                                    কত দিনে সফটওয়্যারটি ডেলিভারি দিবেন?
                                </a>
                            </h5>
                        </div>
                        <div id="collapseThree5" class="collapse" aria-labelledby="headingThree5"
                             data-parent="#accordionExample">
                            <div class="card-body">
                                সহজে সব সফটওয়্যারটি এক দিনেই ডেলিভারি দেওয়া সম্ভব সেক্ষেত্রে আপনাকে কিছু কনটেন্ট প্রদান করতে হবে। আর যদি কাস্টমাইজ সফটওয়্যার হয় সেক্ষেত্রে মডিউল অনুযায়ী আলোচনা সাপেক্ষে সফটওয়্যার ডেলিভারি দেওয়া হয়য়।
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="faq-right">
                    <img src="<?php echo base_url() ?>/uploads/5219088 1.svg" class="img-fluid" alt=""/>
                </div>
            </div>
        </div>
    </div>
