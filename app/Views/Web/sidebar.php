    ...
    <div class="row">
        ...
        <div class="col-12 da-div-pd-20 dapro">
            ...
            <div class="col-md-8 da-pro-con">
                ...
                <p class="wel-tex text-capitalize "><?php echo get_data_by_id('name','customers','customer_id',newSession()->user_id); ?> </p>
            </div>
            </div>
        </div>
        ...
        <div class="col-12 da-div-pd-20">
            <div class="sidebar">
                ...
                <a class="<?php echo ($menu_select == 'shop_create')?'active':'';?>" href="<?php echo base_url('shop_create') ?>"><img src="<?php echo base_url() ?>/images/bi_shop.png" alt="" style="margin-top:-7px;"> আমার শপ</a>

                <a class="<?php echo ($menu_select == 'my_package')?'active':'';?>" href="<?php echo base_url('my_package') ?>"><img src="<?php echo base_url() ?>/images/carbon_settings.png" alt="" style="margin-top:-7px;"> আমার অর্ডার</a>
